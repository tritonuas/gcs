...
import { AirdropTarget, GPSCoord, ODLCObjects } from "../protos/obc.pb";
...
function TargetMatch() {
    ...
    /**
     * The airdrops that exist.
     */
    const airdrop_list = ["Kaz", "Kimi", "Chris", "Daniel"];
    ...
    const lat_lng_template = [
        {
            lat: "",
            lng: "",
            setLat: (value: number | string) => handleUpdate(0, "lat", value),
            setLng: (value: number | string) => handleUpdate(0, "lng", value),
        },
        {
            lat: "",
            lng: "",
            setLat: (value: number | string) => handleUpdate(1, "lat", value),
            setLng: (value: number | string) => handleUpdate(1, "lng", value),
        },
        {
            lat: "",
            lng: "",
            setLat: (value: number | string) => handleUpdate(2, "lat", value),
            setLng: (value: number | string) => handleUpdate(2, "lng", value),
        },
        {
            lat: "",
            lng: "",
            setLat: (value: number | string) => handleUpdate(3, "lat", value),
            setLng: (value: number | string) => handleUpdate(3, "lng", value),
        },
        {
            lat: "",
            lng: "",
            setLat: (value: number | string) => handleUpdate(4, "lat", value),
            setLng: (value: number | string) => handleUpdate(4, "lng", value),
        },
    ];
     ...
     * It has 5 json because there are five airdrops.
     */
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        airdrop_list.forEach((_, index: number) => {
            if (lat_lng[index].lat != "" && lat_lng[index].lng != "") {
                const coordinate: GPSCoord = {
                ...
                const airdrop_target: AirdropTarget = {
                    ...
                    Object: ODLCObjects.Airplane, // TEMP, IDFK WHATS GOING ON HERE ILL FIGURE IT OUT
                };
            ...
            <div className="form-container">
                <form onSubmit={(e) => handleSubmit(e)}>
                    {airdrop_list.map((airdrop, index) => {
                        return (
                            <div className="airdrop" key={index}>
                                <div
                                    style={{
                                        fontSize: "50px",
                                        fontWeight: "bold",
