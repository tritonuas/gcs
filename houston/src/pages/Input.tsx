          ...
          <div className="button-container">
            ...
            <input
              ...
              onClick={() => {
                ...
                setMapData((mapData) => {
                  if (data !== undefined) {
                    return new Map(mapData.set(mapMode, data.concat([newRow])));
                  } else {
...
function WaypointImportModal({
  ...
  const handleSubmit = () => {
    ...
    try {
      ...
      const waypoints = data.map((wp) => [wp.Latitude, wp.Longitude, wp.Altitude]);
      onSubmit(waypoints);
  ...
  return (
    <MyModal modalVisible={modalVisible} closeModal={closeModal}>
      ...
      <p>Format: {'`[{"Latitude": ..., "Longitude": ..., "Altitude": ...}]`'}</p>
      ...
      <div className="button-container" style={{ justifyContent: "flex-end", gap: "10px" }}>
        <input type="button" className="del-btn" onClick={closeModal} value="Cancel" />
            ...
            return (
              <>
                {parsedData.map((latlng, index) => (
                  <Polyline key={index} positions={[latlng, latlng]}></Polyline>
                ))}
              </>
            );
        }
...
function Input() {
  ...
  function handleWaypointImport(newWaypoints: number[][]) {
    ...
    setMapData((mapData) => new Map(mapData.set(MapMode.Waypoint, newWaypoints)));
      ...
      setMapData(
        new Map(
          mapData.set(MapMode.FlightBound, [
            [36.2193143935478, -96.00171089172362],
            [36.2203876816226, -96.0041356086731],
            [36.2208031440207, -96.006817817688],
            [36.2205954130975, -96.0094571113586],
            [36.2198164172223, -96.01181745529171],
            [36.2181891563676, -96.0142421722412],
            [36.2149951257415, -96.0109269618988],
            [36.2128397305797, -96.0107660293579],
            [36.2128051052733, -96.00916743278502],
            [36.2106063669373, -96.00924253463749],
            [36.2106583063506, -96.00173234939579],
          ]),
        ),
      );
      setMapData(
      ...
      setMapData(
        new Map(
          mapData.set(MapMode.Waypoint, [
            ...
            [38.3150939, -76.54163, 68.58], // Runway 2 Waypoint 7 (225ft -> 68.58m)
  ...
  return (
    <>
      <MyModal modalVisible={modalVisible} closeModal={closeModal}>
        ...
        <p>Make sure to input the search zone only with 4 coordinates and in the following order</p>
        <p>bottom left &gt; bottom right &gt; top right &gt; top left</p>
        <fieldset>
          ...
          <label>
            <input
              ...
              onClick={() => changingDeafultView("Black_Mountain")}
            />
            Black Mountain
          </label>
          <label>
        ...
        <div className="right-container">
          ...
          <form className="tuas-form input-controls">
            ...
            {mapMode === MapMode.Waypoint && (
              <input type="button" onClick={openImportModal} value="Import Waypoints"></input>
            )}
          </form>
        </div>
        <MyModal
