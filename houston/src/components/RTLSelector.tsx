    ...
    return (
        <MyModal modalVisible={modalVisible} closeModal={closeModal}>
            ...
            <MyModal modalVisible={confirmModalVisible} closeModal={closeConfirmModal}>
                ...
                <p>
                    CONFIRM that you want the aircraft to return to its launch position.
                    This will override any current mission or flight plan.
                </p>
                <p>
                    Type &quot;CONFIRM RTL&quot; into the text box to initiate the return to launch.
                </p>
                <input type="text" onChange={(txt) => setConfirmInput(txt.target.value)} value={confirmInput} />
                <button className='rtl_button_submit_button'
                    onClick={() => {
