...
func (c *Client) GetPath(latitude float64, longitude float64, altitude float64) (Path, []byte, ut.HTTPError) {
	url := fmt.Sprintf("/path/full?latitude=%f&longitude=%f&heading=0", latitude, longitude, altitude)
